...
class CziSampleInfo:
    ...
    Attributes:
        ...
        well_total_number (Optional[int]): Total number of wells.
        scene_stageX (List[float]): X coordinates of the scene stages.
        scene_stageY (List[float]): Y coordinates of the scene stages.
