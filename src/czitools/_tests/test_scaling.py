    ...
    [
        (
            "CellDivision_T3_Z5_CH2_X240_Y170.czi",
            {
                ...
                "Y_sf": 0.091,
                "Z": 0.32,
                "ratio": {"xy": 1.0, "zx": 3.516, "zx_sf": 3.516},
                "unit": "micron",
                "zoom": 1.0,
            },
        ),
        (
            "Al2O3_SE_020_sp.czi",
            {
                ...
                "Y_sf": 0.028,
                "Z": 1.0,
                "ratio": {"xy": 1.0, "zx": 35.714, "zx_sf": 35.714},
                "unit": "micron",
                "zoom": 1.0,
            },
        ),
        (
            "w96_A1+A2.czi",
            {
                ...
                "Y_sf": 0.457,
                "Z": 1.0,
                "ratio": {"xy": 1.0, "zx": 2.188, "zx_sf": 2.188},
                "unit": "micron",
                "zoom": 1.0,
            },
        ),
        (
            "Airyscan.czi",
            {
                ...
                "Y_sf": 0.044,
                "Z": 1.0,
                "ratio": {"xy": 1.0, "zx": 22.727, "zx_sf": 22.727},
                "unit": "micron",
                "zoom": 1.0,
            },
        ),
        ...
        (
            "Tumor_HE_RGB.czi",
            {
                ...
                "Y_sf": 0.22,
                "Z": 1.0,
                "ratio": {"xy": 1.0, "zx": 4.545, "zx_sf": 4.545},
                "unit": "micron",
                "zoom": 1.0,
            },
        ),
...
def test_scaling2(
    czifile: str, x: float, y: float, z: float, ratio: Dict[str, float]
) -> None:
