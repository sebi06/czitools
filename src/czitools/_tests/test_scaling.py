...
def test_scaling1():
    ...
    results = {0: {'X': 0.09057667415221031, 'Y': 0.09057667415221031, 'Z': 0.32, 'scale_ratio': {'xy': 1.0, 'zx': 3.533}, 'unit': 'micron'},
               1: {'X': 0.02791, 'Y': 0.02791, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 35.829}, 'unit': 'micron'},
               2: {'X': 0.45715068250381635, 'Y': 0.45715068250381635, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 2.187}, 'unit': 'micron'},
               3: {'X': 0.04392940851660524, 'Y': 0.04392940851660524, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 22.764}, 'unit': 'micron'},
               4: {'X': 1.0, 'Y': 1.0, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 1.0}, 'unit': 'micron'},
               5: {'X': 1.0, 'Y': 1.0, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 1.0}, 'unit': 'micron'},
               6: {'X': 0.21999999999999997, 'Y': 0.21999999999999997, 'Z': 1.0, 'scale_ratio': {'xy': 1.0, 'zx': 4.545}, 'unit': 'micron'},
               }
