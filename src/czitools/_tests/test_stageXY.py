...
@pytest.mark.parametrize(
    "czifile, results",
    [
        ("WellD6_S=1.czi", {"X": [49500.0], "Y": [35500.0]}),
        ("WellD6-7_S=2.czi", {"X": [49500.0, 58500.0], "Y": [35500.0, 35500.0]}),
        ("CellDivision_T=3_Z=5_CH=2_X=240_Y=170.czi", {"X": 16977.153, "Y": 18621.489}),
        ...
        ("S=3_1Pos_2Mosaic_T=2=Z=3_CH=2_sm.czi", {"X": [38397.296, 37980.0, 38679.412], "Y": [12724.718, 13020.0, 13260.298]}),
