"""Demonstrate Stage 2 planetable position enrichment of the HCS model.

Run from the repository root:

    python demo/scripts/hcs_stage2_position_enrichment.py
...
from czitools.metadata_tools.hcs import well_relative_field_positions
